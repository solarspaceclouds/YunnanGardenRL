AGENT_NAME                  =       "boar_agent_2"
TEAM_NAME                   =       "solarspaceclouds"

    
# These are algorithm parameters. You need to change this
DELTA                       =      0.1              #   How much should the epsilon shift by in every game
LR                          =      0.2            #   This is the learning rate. High learning rate means faster learning"                     
GAMMA                       =      0.4              #   gamma = discount factor. High gamma value means focus on future rewards "
STARTING_EPSILON            =      0
...
TAKE_DAMAGE                 =      -40     
EARN_AMMO                   =      15
COLLIDE_WITH_WALLS          =      -5
DAMAGE_ITSELF               =      -40      
NO_DESTRUCTION              =      0                 
NO_KILL                     =      -3             
PLACING_BOMBS_WITH_NO_AMMO  =      -5
BOMB_IN_RANGE               =      -2
PLACING_BOMB_ON_TOP_OF_BOMB =      4
EXIST_PENALTY               =      -6



RL_ALGORITHM_TYPE           =       "Q_LEARNING" #"SARSA"    # "SARSA"  ,   "Q_LEARNING",   "DEEPQ"
RADIUS                      =       3   
...
GUIDANCE                    =       0.6                         # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
